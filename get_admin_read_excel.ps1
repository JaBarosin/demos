$logFile = "C:\temp\demosetup\scriptlog.txt"
...
# Your code goes here
Write-Log "About to execute C:\temp\ReadExcel.ps1"
Invoke-Expression -Command "C:\temp\ReadExcel.ps1"
Write-Log "Executed C:\temp\ReadExcel.ps1"
